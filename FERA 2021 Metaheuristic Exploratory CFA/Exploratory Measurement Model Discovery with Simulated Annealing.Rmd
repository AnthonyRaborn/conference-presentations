...
[^1]: Marcoulides & Drezner, 2003; Marcoulides 
et al., 1998; Marcoulides & Falk, 2018
[^2]: Leite et al., 2008; Raborn & Leite, 2018; Raborn et al., 2020
[^3]: Leite et al., 2021.
...
![Hill Climbing with Simulated Annealing](images/Hill_Climbing_with_Simulated_Annealing.gif)[^6]
...
$$ \begin{equation} P(Model_{New}|Fit_{New},Fit_{Old},T) = \\
...
7200 analysis iterations. Only 54 conditions were completed for this presentation.
...
modelChosen <-
  readRDS(file = 'data/which-model-chosen.RDS') %>%
  mutate(
    Correct.Model =
    case_when(
...
resultDF <-
  readRDS(file = 'data/properly-specified-model.RDS') %>%
  filter(Number.of.Factors == 2)
